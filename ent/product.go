...
func (*Product) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case product.FieldName, product.FieldDescription, product.FieldImageURL, product.FieldCategory, product.FieldDesign:
			values[i] = new(sql.NullString)
		case product.FieldCreateTime, product.FieldUpdateTime, product.FieldCreatedAt, product.FieldUpdatedAt:
