...
func (cu *CustomerUpdate) SetWhatsappID(s string) *CustomerUpdate {
	cu.mutation.SetWhatsappID(s)
	return cu
}

// SetNillableWhatsappID sets the "whatsapp_id" field if the given value is not nil.
func (cu *CustomerUpdate) SetNillableWhatsappID(s *string) *CustomerUpdate {
	if s != nil {
		cu.SetWhatsappID(*s)
	}
	return cu
...
func (cu *CustomerUpdate) check() error {
	if v, ok := cu.mutation.WhatsappID(); ok {
		if err := customer.WhatsappIDValidator(v); err != nil {
			return &ValidationError{Name: "whatsapp_id", err: fmt.Errorf(`ent: validator failed for field "Customer.whatsapp_id": %w`, err)}
		}
	}
...
func (cu *CustomerUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.WhatsappID(); ok {
		_spec.SetField(customer.FieldWhatsappID, field.TypeString, value)
	}
...
// SetWhatsappID sets the "whatsapp_id" field.
func (cuo *CustomerUpdateOne) SetWhatsappID(s string) *CustomerUpdateOne {
	cuo.mutation.SetWhatsappID(s)
	return cuo
}

// SetNillableWhatsappID sets the "whatsapp_id" field if the given value is not nil.
func (cuo *CustomerUpdateOne) SetNillableWhatsappID(s *string) *CustomerUpdateOne {
	if s != nil {
		cuo.SetWhatsappID(*s)
	}
	return cuo
...
func (cuo *CustomerUpdateOne) check() error {
	if v, ok := cuo.mutation.WhatsappID(); ok {
		if err := customer.WhatsappIDValidator(v); err != nil {
			return &ValidationError{Name: "whatsapp_id", err: fmt.Errorf(`ent: validator failed for field "Customer.whatsapp_id": %w`, err)}
		}
	}
...
func (cuo *CustomerUpdateOne) sqlSave(ctx context.Context) (_node *Customer, err error) {
	...
	if value, ok := cuo.mutation.WhatsappID(); ok {
		_spec.SetField(customer.FieldWhatsappID, field.TypeString, value)
	}
