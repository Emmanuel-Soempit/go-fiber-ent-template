...
func (pu *ProductUpdate) ClearImageURL() *ProductUpdate {
...
func (pu *ProductUpdate) SetDesign(s string) *ProductUpdate {
	pu.mutation.SetDesign(s)
	return pu
}

// SetNillableDesign sets the "design" field if the given value is not nil.
func (pu *ProductUpdate) SetNillableDesign(s *string) *ProductUpdate {
	if s != nil {
		pu.SetDesign(*s)
	}
	return pu
...
func (pu *ProductUpdate) check() error {
	...
	if v, ok := pu.mutation.Design(); ok {
		if err := product.DesignValidator(v); err != nil {
			return &ValidationError{Name: "design", err: fmt.Errorf(`ent: validator failed for field "Product.design": %w`, err)}
		}
	}
	return nil
}
...
func (pu *ProductUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Design(); ok {
		_spec.SetField(product.FieldDesign, field.TypeString, value)
	}
...
// ClearImageURL clears the value of the "image_url" field.
func (puo *ProductUpdateOne) ClearImageURL() *ProductUpdateOne {
...
// SetDesign sets the "design" field.
func (puo *ProductUpdateOne) SetDesign(s string) *ProductUpdateOne {
	puo.mutation.SetDesign(s)
	return puo
}

// SetNillableDesign sets the "design" field if the given value is not nil.
func (puo *ProductUpdateOne) SetNillableDesign(s *string) *ProductUpdateOne {
	if s != nil {
		puo.SetDesign(*s)
	}
	return puo
...
func (puo *ProductUpdateOne) check() error {
	...
	if v, ok := puo.mutation.Design(); ok {
		if err := product.DesignValidator(v); err != nil {
			return &ValidationError{Name: "design", err: fmt.Errorf(`ent: validator failed for field "Product.design": %w`, err)}
		}
	}
...
func (puo *ProductUpdateOne) sqlSave(ctx context.Context) (_node *Product, err error) {
	...
	if value, ok := puo.mutation.Design(); ok {
		_spec.SetField(product.FieldDesign, field.TypeString, value)
	}
