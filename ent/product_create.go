...
func (pc *ProductCreate) SetDesign(s string) *ProductCreate {
	pc.mutation.SetDesign(s)
	return pc
}
...
func (pc *ProductCreate) check() error {
	...
	if _, ok := pc.mutation.Design(); !ok {
		return &ValidationError{Name: "design", err: errors.New(`ent: missing required field "Product.design"`)}
	}
	if v, ok := pc.mutation.Design(); ok {
...
func (pc *ProductCreate) createSpec() (*Product, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.Design(); ok {
